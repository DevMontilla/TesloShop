...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    if (!ok) {
      // TODO: mostrar mensaje de error si no se puede actualizar o crear el producto
      return;
    }
          ...
          <div className="flex flex-wrap">
            {sizes.map((size) => (
              ...
              <div
                ...
                className={clsx(
                  "p-2 border cursor-pointer rounded-md mr-2 mb-2 w-11 transition-all text-center",
                  {
